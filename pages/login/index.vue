  ...
  <div>
    <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" @submit.prevent="click">
...
export default {
  middleware: ['guest', 'check-auth'],
  layout: 'main',
  data() {
    return {
      User: {
        email: 'gabriel.santos@simplifiqueii.com.br',
        password: 'poeta9142'
      },
      remember_me: false
    }
  ...
  methods: {
    click() {
      ...
      this.$store.dispatch('account_auth/authenticate', params)
        .then(response => {
